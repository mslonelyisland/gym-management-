...
//         const walkinResponse = await axios.get(`http://localhost:3001/walkin?month=${selectedMonth.getMonth() + 1}&year=${selectedMonth.getFullYear()}`);
...
//       const hour = new Date(entry.checkInTimestamp).getHours(); // Adjusted to checkInTimestamp
//       acc[hour] = (acc[hour] || 0) + 1;
//       return acc;
//     }, {});
...
//     return [
//       { id: "attendance", color: theme.palette.secondary.main, data: formattedAttendanceData },
//       { id: "walkin", color: theme.palette.primary.main, data: formattedWalkinData },
//     ];
